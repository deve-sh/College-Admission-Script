...
if($appid==""){
  ...
  if(mysqli_num_rows($ret)==1){
    ...
    if($app['approved']==1||$app['declined']==2){
  	...
  	$update=mysqli_query($db,"UPDATE applications SET approved=2 WHERE appid='$appid'");
  	if($update){
  		echo "<br><br>Application Declined Successfully!";
  		...
  		echo "<br><br>The application could not be declined! Kindly try again!";
  		if($_SESSION['pageid']==1){
  			$_SESSION['pageid']=0;
  			header("refresh:1;url=all.php");
  			exit();
